...
VIDEO_MODELS: Dict[str, ModelConfig] = {
    ...
    # Google Veo (direct API via Gemini)
    "veo-3-1-fast": ModelConfig(
        id="veo-3-1-fast",
        name="Veo 3.1 Fast",
        provider="google",
        model_string="veo-3.1-fast-generate-preview",
        category="video",
        tier="standard",
    ...
    "veo-3": ModelConfig(
        ...
        name="Veo 3",
        provider="google",
        model_string="veo-3-generate-preview",
        category="video",
        tier="pro",
    ...
    "veo-3-fast": ModelConfig(
        id="veo-3-fast",
        name="Veo 3 Fast",
        provider="google",
        model_string="veo-3-fast-generate-preview",
        category="video",
        tier="standard",
    ...
    "veo-2": ModelConfig(
        ...
        name="Veo 2",
        provider="google",
        model_string="veo-2-generate-preview",
        category="video",
        tier="standard",
    ...
    # OpenAI Sora (direct API) — duplicates removed, use "sora-2" and "sora-2-pro" above
